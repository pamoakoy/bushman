...
function show_nav() {
    ...
    if ($no_computing) {
        echo "
            Bushman is a research project that uses volunteers
            to do research in Bushmen.
        ";
    } else {
        echo "
            Bushman is a research project that uses Internet-connected
            computers to do research in Bushmen.
	...
	<li><a href=\"bossa_apps.php\">Be a distributed thinking volunteer</a>
